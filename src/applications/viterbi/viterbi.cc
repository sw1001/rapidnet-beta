...
const string Viterbi::EPRETURN = "ePReturn";
const string Viterbi::EPROVQUERY = "eProvQuery";
const string Viterbi::ERRETURN = "eRReturn";
const string Viterbi::ERULEQUERY = "eRuleQuery";
const string Viterbi::EMATRIXTEMP = "ematrixTemp";
const string Viterbi::EMATRIXTEMPDELETE = "ematrixTempDelete";
const string Viterbi::EMATRIXTEMPTEMP = "ematrixTempTemp";
const string Viterbi::EMATRIXTEMPTEMPDELETE = "ematrixTempTempDelete";
const string Viterbi::EMAXPROB = "emaxProb";
const string Viterbi::EMAXPROBDELETE = "emaxProbDelete";
const string Viterbi::EMAXPROBTEMP = "emaxProbTemp";
const string Viterbi::EMAXPROBTEMPDELETE = "emaxProbTempDelete";
const string Viterbi::EMISSION = "emission";
const string Viterbi::ESHARESULT = "eshaResult";
const string Viterbi::ESHARESULTDELETE = "eshaResultDelete";
const string Viterbi::ESHARESULTTEMP = "eshaResultTemp";
const string Viterbi::ESHARESULTTEMPDELETE = "eshaResultTempDelete";
const string Viterbi::MATRIXTEMP = "matrixTemp";
const string Viterbi::MAXPROB = "maxProb";
const string Viterbi::OBSERVATION = "observation";
const string Viterbi::PITERATE = "pIterate";
const string Viterbi::PQLIST = "pQList";
const string Viterbi::PRESULTTMP = "pResultTmp";
const string Viterbi::PRETURN = "pReturn";
const string Viterbi::PTEMPQUERY = "pTempQuery";
const string Viterbi::PROV = "prov";
const string Viterbi::PROVQUERY = "provQuery";
const string Viterbi::RITERATE = "rIterate";
const string Viterbi::RQLIST = "rQList";
const string Viterbi::RRESULTTMP = "rResultTmp";
const string Viterbi::RRETURN = "rReturn";
const string Viterbi::RULEEXEC = "ruleExec";
const string Viterbi::RULEQUERY = "ruleQuery";
const string Viterbi::SHARESULT = "shaResult";
const string Viterbi::TEMPLIST = "tempList";
const string Viterbi::TRANSITION = "transition";

NS_LOG_COMPONENT_DEFINE ("Viterbi");
NS_OBJECT_ENSURE_REGISTERED (Viterbi);

TypeId
Viterbi::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::rapidnet::viterbi::Viterbi")
    .SetParent<RapidNetApplicationBase> ()
    .AddConstructor<Viterbi> ()
    ;
  return tid;
}
...
void
Viterbi::StartApplication (void)
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StartApplication ();
  RAPIDNET_LOG_INFO("Viterbi Application Started");
}

void
Viterbi::StopApplication ()
{
  NS_LOG_FUNCTION_NOARGS ();

  RapidNetApplicationBase::StopApplication ();
  RAPIDNET_LOG_INFO("Viterbi Application Stopped");
}

void
Viterbi::InitDatabase ()
{
...
void
Viterbi::DemuxRecv (Ptr<Tuple> tuple)
{
...
void
Viterbi::Prov_r1_1Eca0Ins (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_r1_1Eca0Del (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_r1_1Eca3Ins (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_r1_1Eca3Del (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_r1_1Eca7Ins (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_r1_1Eca7Del (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_r1_2_ecaAdd (Ptr<Tuple> ematrixTempTemp)
{
...
void
Viterbi::Prov_r1_2_ecaDel (Ptr<Tuple> ematrixTempTempDelete)
{
...
void
Viterbi::Prov_r1_3_ecaAdd (Ptr<Tuple> ematrixTempTemp)
{
...
void
Viterbi::Prov_r1_3_ecaDel (Ptr<Tuple> ematrixTempTempDelete)
{
...
void
Viterbi::Prov_r1_4_ecaAdd (Ptr<Tuple> ematrixTemp)
{
...
void
Viterbi::Prov_r1_4_ecaDel (Ptr<Tuple> ematrixTempDelete)
{
...
void
Viterbi::Prov_r1_5_ecaAdd (Ptr<Tuple> ematrixTemp)
{
...
void
Viterbi::Prov_r1_5_ecaDel (Ptr<Tuple> ematrixTempDelete)
{
    ...
    FSha1::New (
      Operation::New (RN_PLUS,
        Operation::New (RN_PLUS,
          ...
          ValueExpr::New (StrValue::New (","))),
        VarExpr::New ("ematrixTempDelete_attr5")))));
...
void
Viterbi::Prov_r2_1Eca0Ins (Ptr<Tuple> matrixTemp)
{
  ...
  result->Assign (Assignor::New ("PM1",
    Operation::New (RN_TIMES,
      Operation::New (RN_TIMES,
        VarExpr::New ("matrixTemp_attr5"),
        VarExpr::New ("transition_attr4")),
...
void
Viterbi::Prov_r2_1Eca0Del (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_r2_1Eca3Ins (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_r2_1Eca3Del (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_r2_1Eca7Ins (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_r2_1Eca7Del (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_r2_1Eca11Ins (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_r2_1Eca11Del (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_r3_1Eca0Ins (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_r3_1Eca0Del (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_r3_1Eca3Ins (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_r3_1Eca3Del (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_r3_1Eca7Ins (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_r3_1Eca7Del (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_r4_1Eca0Ins (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_r4_1Eca0Del (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_r4_2_ecaAdd (Ptr<Tuple> emaxProbTemp)
{
...
void
Viterbi::Prov_r4_2_ecaDel (Ptr<Tuple> emaxProbTempDelete)
{
...
void
Viterbi::Prov_r4_3_ecaAdd (Ptr<Tuple> emaxProbTemp)
{
...
void
Viterbi::Prov_r4_3_ecaDel (Ptr<Tuple> emaxProbTempDelete)
{
...
void
Viterbi::Prov_r4_4_ecaAdd (Ptr<Tuple> emaxProb)
{
...
void
Viterbi::Prov_r4_4_ecaDel (Ptr<Tuple> emaxProbDelete)
{
...
void
Viterbi::Prov_r4_5_ecaAdd (Ptr<Tuple> emaxProb)
{
...
void
Viterbi::Prov_r4_5_ecaDel (Ptr<Tuple> emaxProbDelete)
{
    ...
    FSha1::New (
      Operation::New (RN_PLUS,
        Operation::New (RN_PLUS,
          ...
          ValueExpr::New (StrValue::New (","))),
        VarExpr::New ("emaxProbDelete_attr5")))));
...
void
Viterbi::Prov_sr1_1Eca0Ins (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_sr1_1Eca0Del (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_sr1_2_ecaAdd (Ptr<Tuple> eshaResultTemp)
{
...
void
Viterbi::Prov_sr1_2_ecaDel (Ptr<Tuple> eshaResultTempDelete)
{
...
void
Viterbi::Prov_sr1_3_ecaAdd (Ptr<Tuple> eshaResultTemp)
{
...
void
Viterbi::Prov_sr1_3_ecaDel (Ptr<Tuple> eshaResultTempDelete)
{
...
void
Viterbi::Prov_sr1_4_ecaAdd (Ptr<Tuple> eshaResult)
{
...
void
Viterbi::Prov_sr1_4_ecaDel (Ptr<Tuple> eshaResultDelete)
{
...
void
Viterbi::Prov_sr1_5_ecaAdd (Ptr<Tuple> eshaResult)
{
...
void
Viterbi::Prov_sr1_5_ecaDel (Ptr<Tuple> eshaResultDelete)
{
...
void
Viterbi::Prov_sr2_1Eca0Ins (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_sr2_1Eca0Del (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_sr3_1Eca0Ins (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_sr3_1Eca0Del (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_sr4_1Eca0Ins (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_sr4_1Eca0Del (Ptr<Tuple> matrixTemp)
{
...
void
Viterbi::Prov_sr5_1Eca0Ins (Ptr<Tuple> maxProb)
{
...
void
Viterbi::Prov_sr5_1Eca0Del (Ptr<Tuple> maxProb)
{
...
void
Viterbi::Prov_edb_1Eca1Ins (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_edb_1Eca1Del (Ptr<Tuple> emission)
{
...
void
Viterbi::Prov_edb_2Eca1Ins (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_edb_2Eca1Del (Ptr<Tuple> observation)
{
...
void
Viterbi::Prov_edb_3Eca1Ins (Ptr<Tuple> transition)
{
...
void
Viterbi::Prov_edb_3Eca1Del (Ptr<Tuple> transition)
{
...
void
Viterbi::Prep1_eca (Ptr<Tuple> provQuery)
{
  ...
  result = result->Select (Selector::New (
    Operation::New (RN_GTE,
      ...
      ValueExpr::New (Int32Value::New (15)))));
...
void
Viterbi::Prep2_eca (Ptr<Tuple> provQuery)
{
...
void
Viterbi::Prep3_eca (Ptr<Tuple> provQuery)
{
...
void
Viterbi::Prep4_eca (Ptr<Tuple> pTempQuery)
{
...
void
Viterbi::Edb1_eca (Ptr<Tuple> tempList)
{
...
void
Viterbi::Idb1_eca (Ptr<Tuple> tempList)
{
...
void
Viterbi::Idb2_eca (Ptr<Tuple> tempList)
{
...
void
Viterbi::Idb3_eca (Ptr<Tuple> tempList)
{
...
void
Viterbi::Idb4_eca (Ptr<Tuple> pIterate)
{
...
void
Viterbi::Idb5_eca (Ptr<Tuple> pIterate)
{
...
void
Viterbi::Idb6_eca (Ptr<Tuple> eRuleQuery)
{
...
void
Viterbi::Idb7_eca (Ptr<Tuple> rReturn)
{
...
void
Viterbi::Idb8Eca0Ins (Ptr<Tuple> pResultTmp)
{
...
void
Viterbi::Idb8Eca1Ins (Ptr<Tuple> pQList)
{
...
void
Viterbi::Idb9_eca (Ptr<Tuple> ePReturn)
{
...
void
Viterbi::Rv1_eca (Ptr<Tuple> ruleQuery)
{
...
void
Viterbi::Rv2_eca (Ptr<Tuple> ruleQuery)
{
...
void
Viterbi::Rv3_eca (Ptr<Tuple> ruleQuery)
{
...
void
Viterbi::Rv4_eca (Ptr<Tuple> rIterate)
{
...
void
Viterbi::Rv5_eca (Ptr<Tuple> rIterate)
{
...
void
Viterbi::Rv6_eca (Ptr<Tuple> eProvQuery)
{
...
void
Viterbi::Rv7_eca (Ptr<Tuple> pReturn)
{
...
void
Viterbi::Rv8Eca0Ins (Ptr<Tuple> rResultTmp)
{
...
void
Viterbi::Rv8Eca1Ins (Ptr<Tuple> rQList)
{
...
void
Viterbi::Rv9_eca (Ptr<Tuple> eRReturn)
{
